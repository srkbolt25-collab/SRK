...
export default function WashersPage() {
  ...
  const {
    products: washersProducts,
    loading: washersLoading,
    error: washersError,
  } = useCategoryProducts("WASHERS")
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {washersLoading && (
            <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-700">
              Loading latest washers from inventory...
            </div>
          )}
                ...
                <div className="w-full space-y-2.5 mt-auto">
                    <div className="flex gap-2">
                      <button 
                        onClick={(e) => {
                          e.stopPropagation()
                          window.location.href = `/view-details?name=${encodeURIComponent(product.name)}&category=WASHERS`
                        }}
          ...
          <div className="bg-white rounded-2xl p-12 shadow-[0_2px_8px_rgba(0,0,0,0.08)] mb-16">
            <h2 className="text-3xl font-bold text-[#2E1F44] mb-12 text-center">Why Choose Our Washers?</h2>

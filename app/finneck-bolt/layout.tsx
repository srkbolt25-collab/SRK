...
export const metadata: Metadata = {
  title: "Finneck Supplier in Dubai – Srkbolt.com",
  description:
  ...
  keywords:
    " Finneck bolt supplier Dubai, Finneck bolts UAE, industrial bolts Dubai, fasteners suppliers UAE, heavy duty bolts Dubai, stainless steel bolts UAE, bolt manufacturers Dubai, construction fasteners UAE.",
}

...
export default function BoltsPage() {
  ...
  const {
    products: boltsProducts,
    loading: boltsLoading,
    error: boltsError,
  } = useCategoryProducts("BOLTS")
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {boltsLoading && (
            <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-700">
              Loading latest bolts from inventory...
            </div>
          )}
          ...
          <div className="bg-white rounded-2xl p-12 shadow-[0_2px_8px_rgba(0,0,0,0.08)] mb-16">
            <h2 className="text-3xl font-bold text-[#2E1F44] mb-12 text-center">Why Choose Our Bolts?</h2>

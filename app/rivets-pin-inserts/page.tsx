...
import { ChevronLeft, ChevronRight, ExternalLink, Zap, Settings, Factory, MessageCircle, FileText, CheckCircle, Shield } from "lucide-react"
...
export default function RivetsPinInsertsPage() {
  ...
  const {
    products: rivetsProducts,
    loading: rivetsLoading,
    error: rivetsError,
  } = useCategoryProducts("RIVETS, PIN & INSERTS")
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-[#2E1F44] mb-6">Rivets, Pins & Inserts</h1>
            <p className="text-[rgba(46,31,68,0.85)] text-xl max-w-4xl mx-auto leading-relaxed">
              Precision-engineered rivets, pins, and inserts designed for structural integrity and secure fastening across automotive, aerospace, and industrial applications.
            </p>
          </div>
          ...
          {rivetsLoading && (
            <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-700">
              Loading latest rivets, pins & inserts from inventory...
            </div>
          )}
          
          {/* Product Grid */}
          {(!rivetsLoading && rivetsProducts.length === 0) ? (
          ...
          <div className="bg-white rounded-2xl p-12 shadow-[0_2px_8px_rgba(0,0,0,0.08)] mb-16">
            <h2 className="text-3xl font-bold text-[#2E1F44] mb-12 text-center">Why Choose Our Rivets, Pins & Inserts?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="bg-[#F7F7FA] rounded-xl p-8 shadow-sm">
                  ...
                  <h3 className="text-xl font-semibold text-[#2E1F44] mb-3">Precision Fit</h3>
                  <p className="text-[rgba(46,31,68,0.85)] text-sm leading-relaxed">
                    Ensures secure fastening with minimal tolerances for high-stress applications.
                  </p>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-[#F7F7FA] rounded-xl p-8 shadow-sm">
                  ...
                  <h3 className="text-xl font-semibold text-[#2E1F44] mb-3">Durable Construction</h3>
                  <p className="text-[rgba(46,31,68,0.85)] text-sm leading-relaxed">
                    Manufactured using high-quality materials to resist shear, tension, and wear.
                  </p>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-[#F7F7FA] rounded-xl p-8 shadow-sm">
                  ...
                  <h3 className="text-xl font-semibold text-[#2E1F44] mb-3">Versatile Applications</h3>
                  <p className="text-[rgba(46,31,68,0.85)] text-sm leading-relaxed">
                    Suitable for aerospace, automotive, marine, and heavy-engineering sectors.
                  </p>
                </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-[#A02222] text-white">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">Need Custom Rivets, Pins & Inserts?</h2>
            <p className="text-lg text-white/85 max-w-2xl mx-auto">
              Contact our precision engineering team for custom rivet, pin, and insert specifications. We deliver tailored fastening components for your exact requirements.
            </p>

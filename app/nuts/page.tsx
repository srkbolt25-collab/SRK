...
import { ChevronLeft, ChevronRight, ExternalLink, Settings, Wrench, Factory, MessageCircle, FileText, CheckCircle } from "lucide-react"
  ...
  const nutsProducts = [
    {
      ...
      description: "Standard hex nuts for general purpose fastening",
      price: "₹12.50",
      category: "NUTS",
      inStock: true
    },
    {
      ...
      name: "Lock Nuts",
      image: "https://www.husainibrothers.com/cdn/images/200/5921504842_1635755736.jpg",
      description: "Self-locking nuts to prevent loosening",
      price: "₹18.75",
      category: "NUTS",
      inStock: true
    },
    {
      ...
      name: "Wing Nuts",
      image: "https://www.husainibrothers.com/cdn/images/200/5921504842_1635755736.jpg",
      description: "Hand-tightening wing nuts for easy adjustment",
      price: "₹15.20",
      category: "NUTS",
      inStock: true
    },
    {
      ...
      name: "Cap Nuts",
      image: "https://www.husainibrothers.com/cdn/images/200/5921504842_1635755736.jpg",
      description: "Decorative cap nuts with finished appearance",
      price: "₹22.80",
      category: "NUTS",
      inStock: true
    },
    {
      ...
      name: "Flange Nuts",
      image: "https://www.husainibrothers.com/cdn/images/200/5921504842_1635755736.jpg",
      description: "Flange nuts with built-in washer for better distribution",
      price: "₹28.90",
      category: "NUTS",
      inStock: true
    },
    {
      ...
      name: "Square Nuts",
      image: "https://www.husainibrothers.com/cdn/images/200/5921504842_1635755736.jpg",
      description: "Square nuts for channel and track applications",
      price: "₹16.60",
      category: "NUTS",
      inStock: true
    }
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-gray-800 mb-6">Nuts Collection</h1>
            <p className="text-gray-600 text-xl max-w-4xl mx-auto leading-relaxed">
              Explore our extensive range of high-quality nuts designed for secure fastening applications. 
              From standard hex nuts to specialized locking nuts, we provide reliable threaded components 
              for every industrial and construction need.
            </p>
          </div>
              ...
              <div key={product.id} className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                <div className="relative h-64 overflow-hidden">
                  ...
                  <div className="absolute top-4 right-4">
                    <span className="bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-semibold">NUTS</span>
                  </div>
                </div>
                <div className="p-6">
          ...
          <div className="bg-linear-to-br from-gray-50 to-gray-100 rounded-2xl p-12 mb-16">
            <h2 className="text-3xl font-bold text-gray-800 mb-12 text-center">Why Choose Our Nuts?</h2>
              ...
              <div className="text-center">
                <div className="bg-white rounded-xl p-8 shadow-lg">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Accurate thread profiles and consistent pitch for reliable engagement with bolts.
                  </p>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-xl p-8 shadow-lg">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mb-3">Secure Locking</h3>
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Advanced locking mechanisms prevent loosening in high-vibration environments.
                  </p>
                </div>
              </div>
              <div className="text-center">
                <div className="bg-white rounded-xl p-8 shadow-lg">
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed">
                    Manufactured from high-grade materials for long-lasting performance and corrosion resistance.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              Need Specialized Nuts?
            </h2>
            <p className="text-lg mb-8 max-w-2xl mx-auto">
              Contact our technical team for custom nut specifications and bulk orders. 
              We provide tailored threaded solutions for your specific applications.
            </p>

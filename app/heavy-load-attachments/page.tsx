...
export default function HeavyLoadAttachmentsPage() {
  ...
  const {
    products: heavyLoadProducts,
    loading: heavyLoadLoading,
    error: heavyLoadError,
  } = useCategoryProducts("HEAVY LOAD ATTACHMENTS")
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            <h1 className="text-4xl font-bold text-[#2E1F44] mb-6">Heavy Load Attachments</h1>
            <p className="text-[rgba(46,31,68,0.85)] text-xl max-w-4xl mx-auto leading-relaxed">
              Industrial-grade lifting and rigging attachments designed to handle heavy loads safely and efficiently.
            </p>
          </div>
          ...
          {heavyLoadLoading && (
            <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 px-4 py-3 text-sm text-blue-700">
              Loading heavy load attachments from inventory...
            </div>
          )}
          
          {/* Product Grid */}
          {(!heavyLoadLoading && heavyLoadProducts.length === 0) ? (
            <div className="mb-16 rounded-2xl border border-dashed border-gray-300 bg-gray-50 p-12 text-center text-gray-500">
              No heavy load attachments are currently available. Add new products from the admin dashboard to populate this collection.
            </div>
          ) : (
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {heavyLoadProducts.map((product) => (
              <div 
                ...
                onClick={() => window.location.href = `/view-details?name=${encodeURIComponent(product.name)}&category=HEAVY%20LOAD%20ATTACHMENTS`}
              >
                ...
                <div className="w-full space-y-2.5 mt-auto">
                    <div className="flex gap-2">
                      ...
                      onClick={(e) => {
                        e.stopPropagation()
                        window.location.href = `/view-details?name=${encodeURIComponent(product.name)}&category=HEAVY%20LOAD%20ATTACHMENTS`
                      }}
          ...
          <div className="bg-white rounded-2xl p-12 shadow-[0_2px_8px_rgba(0,0,0,0.08)] mb-16">
            <h2 className="text-3xl font-bold text-[#2E1F44] mb-12 text-center">Why Choose Our Heavy Load Attachments?</h2>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="bg-[#F7F7FA] rounded-xl p-8 shadow-sm">
                  ...
                  <h3 className="text-xl font-semibold text-[#2E1F44] mb-3">Maximum Strength</h3>
              ...
              <div className="text-center">
                <div className="bg-[#F7F7FA] rounded-xl p-8 shadow-sm">
                  ...
                  <h3 className="text-xl font-semibold text-[#2E1F44] mb-3">Structural Grade</h3>
                  <p className="text-[rgba(46,31,68,0.85)] text-sm leading-relaxed">
              ...
              <div className="text-center">
                <div className="bg-[#F7F7FA] rounded-xl p-8 shadow-sm">
                  ...
                  <h3 className="text-xl font-semibold text-[#2E1F44] mb-3">Industrial Certified</h3>
                  <p className="text-[rgba(46,31,68,0.85)] text-sm leading-relaxed">
      ...
      <section className="py-16 bg-[#A02222] text-white">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto space-y-6">
            <h2 className="text-3xl md:text-4xl font-bold">Need Custom Heavy Load Solutions?</h2>
            <p className="text-lg text-white/85 max-w-2xl mx-auto">
              Contact our engineering team for custom heavy load attachment specifications and bulk orders. We provide tailored structural solutions for your specific load and application requirements.
            </p>
